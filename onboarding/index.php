...
<div class="container-fluid">
    ...
    <script src="<?php echo $_ENV["ONBOARDING_BASE_URL"]; ?>/onboarding.api.js?company_id=<?php echo $merchant_data->id; ?>&api_key=<?php echo $merchant_data->security->key1; ?>"></script>
  </body>
</html>
